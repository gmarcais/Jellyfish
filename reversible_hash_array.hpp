#ifndef __REVERSIBLE_HASH_ARRAY__
#define __REVERSIBLE_HASH_ARRAY__
...
namespace jellyfish {
  namespace reversible_hash {
    ...
    public:
      ...
      bool add(size_t id, word key, word val, bool large = false) {
        uint_t    reprobe     = 0;
        offset_t *o, *lo, *ao;
        word     *w, *kw, *vw, nkey;
...
#endif // __REVERSIBLE_HASH_ARRAY__
