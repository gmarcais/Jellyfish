...
#define GENERATE_SEQUENCE_CMDLINE_PACKAGE "generate_sequence"
#endif

#ifndef GENERATE_SEQUENCE_CMDLINE_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define GENERATE_SEQUENCE_CMDLINE_PACKAGE_NAME "generate_sequence"
#endif

#ifndef GENERATE_SEQUENCE_CMDLINE_VERSION
/** @brief the program version */
#define GENERATE_SEQUENCE_CMDLINE_VERSION VERSION
#endif

/** @brief Where the command line options are stored */
struct generate_sequence_args
{
  ...
  int* mer_arg;	/**< @brief Mer length. Generate matrix of size 2*length.  */
  char ** mer_orig;	/**< @brief Mer length. Generate matrix of size 2*length original value given at command line.  */
  unsigned int mer_min; /**< @brief Mer length. Generate matrix of size 2*length's minimum occurreces */
  unsigned int mer_max; /**< @brief Mer length. Generate matrix of size 2*length's maximum occurreces */
  const char *mer_help; /**< @brief Mer length. Generate matrix of size 2*length help description.  */
  char * output_arg;	/**< @brief Output prefix (default='output').  */
...
struct generate_sequence_cmdline_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure generate_sequence_args (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure generate_sequence_args (default 0) */
