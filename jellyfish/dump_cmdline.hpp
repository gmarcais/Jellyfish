...
#define DUMP_CMDLINE_PACKAGE "jellyfish stats"
#endif

#ifndef DUMP_CMDLINE_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define DUMP_CMDLINE_PACKAGE_NAME "jellyfish stats"
#endif

#ifndef DUMP_CMDLINE_VERSION
/** @brief the program version */
#define DUMP_CMDLINE_VERSION VERSION
#endif
...
struct dump_cmdline_params
{
  ...
  int initialize; /**< @brief whether to initialize the option structure dump_args (default 1) */
  int check_required; /**< @brief whether to check that all required options were provided (default 1) */
  int check_ambiguity; /**< @brief whether to check for options already specified in the option structure dump_args (default 0) */
