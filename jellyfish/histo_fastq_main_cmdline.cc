/*
  ...
  gengetopt --show-required --default-option -c cc -H hpp -F histo_fastq_main_cmdline -f histo_fastq_main_cmdline -a histo_fastq_main_args --unamed-opts=database.jf
