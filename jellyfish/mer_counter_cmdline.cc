/*
  ...
  /genome4/raid/gus/Source/gengetopt-2.22.4/src/gengetopt --show-required --default-option -c cc -H hpp -F mer_counter_cmdline -f mer_counter_cmdline -a mer_counter_args --unamed-opts=file.f[aq]
