...
#ifndef __JELLYFISH_INVERTIBLE_HASH__
#define __JELLYFISH_INVERTIBLE_HASH__
...
namespace jellyfish { namespace invertible_hash {
 ...
 * not to be zero.
 */
template <typename word, typename atomic_t = atomic::gcc, typename mem_block_t = allocators::mmap>
...
public:
  ...
  array(size_t _size, uint_t _key_len, uint_t _val_len,
        uint_t _reprobe_limit, size_t *_reprobes = jellyfish::quadratic_reprobes) :
...
#endif // __JELLYFISH_INVERTIBLE_HASH__
