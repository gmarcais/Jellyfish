/*
  ...
  /genome4/raid/gus/Source/gengetopt-2.22.4/src/gengetopt --show-required --default-option -c cc -H hpp -F hash_fastq_merge_cmdline -f hash_fastq_merge_cmdline -a hash_fastq_merge_args --unamed-opts=database.jf
...
init_help_array(void)
{
  ...
  hash_fastq_merge_args_help[7] = hash_fastq_merge_args_full_help[7];
  hash_fastq_merge_args_help[8] = 0; 
  
}

const char *hash_fastq_merge_args_help[9];
...
void init_args_info(struct hash_fastq_merge_args *args_info)
{
  ...
  args_info->threads_help = hash_fastq_merge_args_full_help[6] ;
  args_info->reprobes_help = hash_fastq_merge_args_full_help[7] ;
  args_info->out_buffer_size_help = hash_fastq_merge_args_full_help[8] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "hVs:m:o:t:p:", long_options, &option_index);
